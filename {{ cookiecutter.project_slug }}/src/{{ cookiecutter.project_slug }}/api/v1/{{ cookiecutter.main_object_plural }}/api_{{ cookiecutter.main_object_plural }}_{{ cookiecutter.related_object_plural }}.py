...
from {{ cookiecutter.project_slug }}.api.v1.persons.services import ReadService, WriteService
from {{ cookiecutter.project_slug }}.api.v1.policies.services import ReadService as PolicyReadService
from {{ cookiecutter.project_slug }}.api.v1.policies.services import WriteService as PolicyWriteService
...
from {{ cookiecutter.project_slug }}.domain.entities import Person, PersonCreate, PersonFilter
from {{ cookiecutter.project_slug }}.domain.entities.policy import Policy
from {{ cookiecutter.project_slug }}.domain.entities.policy_create import PolicyCreate
